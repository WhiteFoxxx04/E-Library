                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button class="btn btn-primary" ID="btnPublisher" runat="server" Text="Go" />
                                    </div>
                                </div>
                            </div> 
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="txtPublisherName" runat="server" placeholder="Author Name"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="col-md-7">
                <div class="card card-author-bg">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered" ID="grdViewPublisherMgmt" runat="server"></asp:GridView>
                            </div>
                        </div>
                    </div>
                </div>
